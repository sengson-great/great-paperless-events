                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-4">
                            <a 
                                ...
                                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-linear-to-r hover:from-teal-600 hover:to-cyan-600 transition-all hover:scale-110"
                            >
