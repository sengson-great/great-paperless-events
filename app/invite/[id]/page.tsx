...
import { Heart, LogIn, Share2, Copy, Check, Home, Calendar, Lock, AlertCircle } from 'lucide-react';
      ...
      <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-pink-50 to-purple-50 p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Private Invitation</h1>
            <p className="text-gray-600">
              This invitation is private. Please enter the PIN provided by the host.
            </p>
          </div>
      ...
      <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-pink-50 to-purple-50 p-4">
        <div className="text-center">
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md">
            ...
            <p className="text-gray-600 mb-6">This invitation requires a PIN to view.</p>
            <button
                    ...
                    <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <a 
                          ...
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="font-medium text-purple-600 hover:text-purple-800 hover:underline transition break-words"
                          title={invitation.eventData.location}
                        >
                          {cleanUrlDisplay(invitation.eventData.location)}
                        </a>
